...
namespace RemoteBakery.Migrations
{
    ...
    [Migration("20201118201106_AddOrderTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemoteBakery.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("RemoteBakery.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("RemoteBakery.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("RemoteBakery.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RemoteBakery.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("RemoteBakery.Models.OrderDetail", b =>
                {
                    b.HasOne("RemoteBakery.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RemoteBakery.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RemoteBakery.Models.Pie", b =>
                {
                    b.HasOne("RemoteBakery.Models.Category", "Category")
                        .WithMany("Pies")
